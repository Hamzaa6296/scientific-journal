...
let NotificationsController = class NotificationsController {
    ...
    getMyNotifications(req, page, limit) {
        return this.notificationsService.getMyNotifications(req.user.userId, page ? Number(page) : 1, limit ? Number(limit) : 20);
    }
    getUnreadCount(req) {
